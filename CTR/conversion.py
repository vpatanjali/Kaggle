...
def read_data():
    ...
    header = "ID,date,hour,C1,banner_pos,site_id,site_domain,site_category,app_id,app_domain,app_category,device_model,device_type,device_conn_type,C14,C15,C16,C17,C18,C19,C20,C21,bias,click"
    dtype_dict_prof = {}
    for key in header.split(','):
        dtype_dict_prof[key] = 'float'
    
    #test_data = pandas.read_csv('/home/patanjali/Kaggle/Data/CTR/profiles.csv',
    #                            chunksize = 10000000, dtype = dtype_dict)
    train_data = pandas.read_csv('/home/patanjali/Kaggle/Data/CTR/profiles_hash.csv', 
                                 chunksize = 1000000, dtype = dtype_dict_prof)
    ...
    for chunk in train_data:
        i += 1
        print i
        store.append('train_hash_profiles',chunk)#,data_columns=True)
